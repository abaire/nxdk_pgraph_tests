...
class LightControlTestMeshTorusModel : public PBKitPlusPlus::SolidColorModelBuilder {
 public:
  ...
  LightControlTestMeshTorusModel(const vector_t &diffuse, const vector_t &specular, const vector_t &back_diffuse,
