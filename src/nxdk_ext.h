...
// From pbgl
// I've never seen a game set bit 1, I think SEPARATE_SPECULAR_EN is just "1"
...
#define NV097_SET_LIGHT_CONTROL_ALPHA 0xFFFE0000
#define NV097_SET_LIGHT_CONTROL_V_ALPHA_OPAQUE 0
#define NV097_SET_LIGHT_CONTROL_V_ALPHA_FROM_MATERIAL (1 << 17)
