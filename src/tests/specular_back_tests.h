#ifndef NXDK_PGRAPH_TESTS_SPECULAR_BACK_TESTS_H
#define NXDK_PGRAPH_TESTS_SPECULAR_BACK_TESTS_H
 ...
 * lighting settings and specular params.
 */
class SpecularBackTests : public TestSuite {
 public:
  SpecularBackTests(TestHost& host, std::string output_dir, const Config& config);
...
#endif  // NXDK_PGRAPH_TESTS_SPECULAR_BACK_TESTS_H
