...
static constexpr auto kUnknownPixelFormat = SDL_PIXELFORMAT_BGRA8888;
constexpr TextureFormatInfo kTextureFormats[] = {
    ...
    //{kUnknownPixelFormat, NV097_SET_TEXTURE_FORMAT_COLOR_LU_IMAGE_R8B8, 16, false, true, true, "R8B8"},
    ...
    {kUnknownPixelFormat, NV097_SET_TEXTURE_FORMAT_COLOR_LU_IMAGE_A8, 8, false, true, false, "A8"},
    ...
    {kUnknownPixelFormat, NV097_SET_TEXTURE_FORMAT_COLOR_SZ_A8, 8, true, false, false, "A8"},
